...
#define  DMA_IRQ_EN(DMA_CHn)    DMA_DCR(DMA_CHn)  |= DMA_DCR_EINT_MASK; enable_irq((DMA_CHn) + 0)  //允许DMA通道传输
#define  DMA_IRQ_DIS(DMA_CHn)   DMA_DCR(DMA_CHn)  &= ~DMA_DCR_EINT_MASK;disable_irq((DMA_CHn) + 0)  //禁止DMA通道传输
